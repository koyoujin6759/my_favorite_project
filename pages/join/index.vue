    ...
    <div class="login-wrap">
        ...
        <div class="login-form-wrap">
            <form>
                ...
                <div class="login-input-wrap mgbt10">
                    <input v-model="userPassword" type="password" required="required" name="userPassword" placeholder="패스워드를 다시 입력해주세요" ></input>
                </div>
                <div class="login-error-msg">
                    <p>{{pwErrMsg}}</p>
                </div>
                <div class="login-submit-wrap">
                    <button class="btn-login" v-on:click="OnClickLoginButton">회원가입</button>
                </div>
            </form>
        </div>
    </div>
